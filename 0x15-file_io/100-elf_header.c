...
/**
 * check_elf - Checks if file is ELF form
 * @e_ident: ptr to array with the ELF magic numbs
 *
 ...
 * @e_ident: ptr to array with ELF magic numbers
 *
 ...
 * @e_ident: ptr to array with the ELF class
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
 ...
 * @e_ident: ptr to array with ELF version
 */
void print_version(unsigned char *e_ident)
{
	printf(" Version: %d",
...
/**
 * print_osabi - Prints OS/ABI of the ELF header
 * @e_ident: ptr to array with the ELF version
 */
void print_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI: ");
 ...
 * @e_ident: ptr to array with the ELF ABI version
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * ELF header file at the start of ELF file
 * @argc: number of args supplied to the program
 * @argv: array of pts to the args
 *
 * Return: 0 on success
 *
